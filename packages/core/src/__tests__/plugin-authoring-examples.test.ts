...
import { destroyAll, selectText } from './test-utils';
...
describe('plugin authoring examples: highlight-plugin', () => {
  it('registers a command and toggle button that wraps and unwraps selection', () => {
    ...
    expect(ed.getContent()).toContain('<mark>hello</mark>');
