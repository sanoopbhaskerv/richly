...
export const icons: Record<string, string> = {
  ...
  textmore: svg('<path d="M4 6h11M9.5 6v12M6.5 18h6M18 9v6M15 12h6"/>'),
  insertmore: svg('<path d="M12 5v14M5 12h14"/>'),
  documenttools: svg(
    '<path d="M4 6h10M4 12h16M10 18h10"/><circle cx="17" cy="6" r="2"/><circle cx="7" cy="18" r="2"/>'
  ),
  ...
  h4: svg('<path d="M4 6v12M11 6v12M4 12h7M20 18v-8l-5 5h6"/>'),
  h5: svg('<path d="M4 6v12M11 6v12M4 12h7M20 10h-5v4h3a2 2 0 1 1 0 4h-3"/>'),
  h6: svg('<path d="M4 6v12M11 6v12M4 12h7M20 10h-2a3 3 0 0 0-3 3v2a3 3 0 1 0 3-3h-3"/>'),
  ...
  lineheight: svg('<path d="M9 6h11M9 12h11M9 18h11M4 5v14M2 7l2-2 2 2M2 17l2 2 2-2"/>'),
  bullist: svg(
