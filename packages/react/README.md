...
| `toolbarPreset`   | `'essential' \| 'standard' \| 'complete'` | Named grouped toolbar; `toolbar` takes precedence.                         |
| `toolbarMode`     | `'wrap' \| 'more' \| 'sliding'`           | Wrap groups, float overflow, or reveal an inline overflow drawer.          |
...
| `textStyles`      | `EditorConfig['textStyles']`              | Colors, font sizes, and unitless line-height options.                      |
| `listStyles`      | `EditorConfig['listStyles']`              | Relabel or restrict portable bullet and numbered markers.                  |
